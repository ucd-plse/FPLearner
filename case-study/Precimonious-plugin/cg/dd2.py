...
time_predictor.load_state_dict(torch.load("../src/time_ggnn_5graphs_trl.pt", map_location=DEVICE))
...
error_predictor.load_state_dict(torch.load("../src/error_ggnn_5graphs_trl.pt", map_location=DEVICE))
