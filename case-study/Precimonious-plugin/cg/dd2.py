...
time_predictor.load_state_dict(torch.load("../src/time_ggnn_5graphs_trl.pt", map_location='cuda:0'))
print("Runtime time_predictor {} is loaded.".format("../src/time_ggnn_5graphs_trl.pt"))
time_predictor.to(DEVICE)
time_predictor.eval()

error_predictor = model.HeteroGNN(GRAPHS.split('_'))
error_predictor.load_state_dict(torch.load("../src/error_ggnn_5graphs_trl.pt", map_location='cuda:0'))
print("Error error_predictor {} is loaded.".format("../src/error_ggnn_5graphs_trl.pt"))
...
def run_orig_config(search_config, original_config, benchmark):
  ...
  os.system("rm -rf ../tempscripts/{}".format(benchmark.upper()))
