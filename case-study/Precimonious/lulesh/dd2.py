...
time_predictor.load_state_dict(torch.load("../src/time.pt", map_location='cuda:0'))
...
error_predictor.load_state_dict(torch.load("../src/error.pt", map_location='cuda:0'))
